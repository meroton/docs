...
There are two take-home messages:
  ...
  * Two, that you can leverage our code to plot allocations for your programs.
  Read the [Python script] section, and checkout the code [from github].

[Plotting memusagestat's data]: /docs/captains-log/plotting-memusagestat-with-python/
[building glibc]: /docs/captains-log/Plotting-memusagestat-with-python/#building-memusagestat-and-glibc
[Python script]:  /docs/captains-log/Plotting-memusagestat-with-python/#parse-the-binary-file-in-python
